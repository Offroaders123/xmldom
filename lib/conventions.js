 ...
 *
 * @param {T[]} list
 * @param {(item: T, index: number, list:T[])=>boolean} predicate
 ...
 */
var HTML_BOOLEAN_ATTRIBUTES = freeze(/** @type {const} */ ({
 ...
 */
var HTML_VOID_ELEMENTS = freeze(/** @type {const} */ ({
	area: true,
	base: true,
	br: true,
	col: true,
 ...
 */
var HTML_RAW_TEXT_ELEMENTS = freeze(/** @type {const} */ ({
	script: false,
	style: false,
	textarea: true,
	title: true,
 ...
 */
var MIME_TYPE = freeze(/** @type {const} */ ({
	/**
...
/**
 * @typedef {typeof MIME_TYPE[keyof typeof MIME_TYPE]}
 * MimeType
 */
/**
 * @type {MimeType[]}
...
var _MIME_TYPES = Object.keys(MIME_TYPE).map(function (key) {
	return MIME_TYPE[/** @type {keyof typeof MIME_TYPE} */ (key)];
});
 ...
 *
 * @param {string} mimeType
 * @returns {mimeType is MimeType}
 *
 */
function isValidMimeType(mimeType) {
	return _MIME_TYPES.indexOf(/** @type {MimeType} */ (mimeType)) > -1;
}
/**
 ...
 */
var NAMESPACE = freeze(/** @type {const} */ ({
	/**
	 * The XHTML namespace.
	 *
