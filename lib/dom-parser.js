 ...
 * @property {typeof conventions.assign} [assign]
 ...
 * @property {(level:ErrorLevel, message:string, context: DOMHandler)=>void}
 * [onError]
 ...
 * Default is true.
 * @property {(ending:string) => string} [normalizeLineEndings]
...
function DOMParser(options) {
	 ...
	 * most implementations.
	 *
	 * @type {(level:ErrorLevel, message:string, context: DOMHandler)=>void}
...
DOMHandler.prototype = {
	 ...
	 * @param {string} qName
	 * @param {sax.TElementAttributes} attrs
	 * @returns {void}
	 */
 ...
 * @param {Element | Comment | DocumentType} node
 * @returns {void}
 */
