 ...
 * @param {symbol} symbol
 * @returns {asserts symbol is symbol}
 */
...
function validateAndExtract(namespace, qualifiedName) {
	...
	if (qualifiedName.indexOf(':') >= 0) {
		var splitResult = /** @type {[string, string]} */ (qualifiedName.split(':'));
 ...
 * @deprecated
 *
 * @param {new (...args: any[]) => object} Class
 * The class that is to be extended.
 * @param {new (...args: any[]) => object} Super
...
var ELEMENT_NODE = NodeType.ELEMENT_NODE;
var ATTRIBUTE_NODE = NodeType.ATTRIBUTE_NODE;
var TEXT_NODE = NodeType.TEXT_NODE;
var CDATA_SECTION_NODE = NodeType.CDATA_SECTION_NODE;
var ENTITY_REFERENCE_NODE = NodeType.ENTITY_REFERENCE_NODE;
var ENTITY_NODE = NodeType.ENTITY_NODE;
var PROCESSING_INSTRUCTION_NODE = NodeType.PROCESSING_INSTRUCTION_NODE;
var COMMENT_NODE = NodeType.COMMENT_NODE;
var DOCUMENT_NODE = NodeType.DOCUMENT_NODE;
var DOCUMENT_TYPE_NODE = NodeType.DOCUMENT_TYPE_NODE;
var DOCUMENT_FRAGMENT_NODE = NodeType.DOCUMENT_FRAGMENT_NODE;
var NOTATION_NODE = NodeType.NOTATION_NODE;

var DocumentPosition = conventions.freeze(/** @type {const} */ ({
 ...
 * @param {string[]} [visibleNamespaces]
 */
function serializeToString(node, buf, nodeFilter, visibleNamespaces) {
	if (!visibleNamespaces) {
		visibleNamespaces = [];
	}
	var doc = node.nodeType === DOCUMENT_NODE ? node : /** @type {Document} */ (node).ownerDocument;
